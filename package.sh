...
tar -cvvf dozenal_v0.99.4_src.tar ./dozenal/dec ./dozenal/doz \
./dozenal/dozdc ./dozenal/tgmconv ./dozenal/dozword \
./dozenal/install.sh ./dozenal/uninstall.sh;
tar -f dozenal_v0.99.4_src.tar --wildcards --verbose --delete *.o ./dozenal/dozdc/dozdc ./dozenal/doz/doz ./dozenal/dec/dec ./dozenal/tgmconv/tgmconv ./dozenal/dozword/dozword;
gzip dozenal_v0.99.4_src.tar;
